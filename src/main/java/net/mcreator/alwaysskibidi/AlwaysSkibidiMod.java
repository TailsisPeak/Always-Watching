package net.mcreator.alwaysskibidi;
...
@Mod("always_skibidi")
public class AlwaysSkibidiMod {
	public static final Logger LOGGER = LogManager.getLogger(AlwaysSkibidiMod.class);
	public static final String MODID = "always_skibidi";

	public AlwaysSkibidiMod(IEventBus modEventBus) {
